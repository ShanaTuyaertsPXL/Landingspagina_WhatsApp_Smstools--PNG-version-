    ...
    <div class="container-fluid pb-5" id="software">
      <div class="container-xl">
        ...
        <div class="row mb-5 ">
          ...
          <div
              class="offset-xl-0 offset-lg-0 offset-md-1 offset-sm-1 offset-1 col-xl-7 col-lg-7 col-md-10 col-sm-10 col-10 image_info_whatsapp" data-aos="fade-left" data-aos-duration="1200" data-aos-offset="600">
            <!--            <i :class="item.icon"></i>-->
        ...
        <div class="row mb-5 ">
          ...
          <div class="offset-xl-0 offset-lg-0 offset-md-1 offset-sm-1 offset-1 col-xl-7 col-lg-7 col-md-10 col-sm-10 col-10 image_info_whatsapp" data-aos="fade-right" data-aos-duration="1200" data-aos-offset="600">
            <!--            <i :class="item.icon"></i>-->
